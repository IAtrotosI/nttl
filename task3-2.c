 ...
 * @param n - Количество первых членов последовательности для части a.
 * @param sumN - Сумма первых n членов последовательности.
 * @param e - Заданная точность (минимальный модуль члена) для части b.
 * @param sumE - Сумма членов последовательности с модулем >= e.
